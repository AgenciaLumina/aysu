    ...
    <div className="min-h-screen">
      ...
      <section className="relative pt-16 min-h-[90vh] flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0 w-full h-full pointer-events-none">
          <iframe
            className="absolute left-1/2 top-1/2 h-[56.25vw] w-[177.78vh] min-h-full min-w-full max-w-none -translate-x-1/2 -translate-y-1/2 scale-[1.08] grayscale-[0.3] md:scale-[1.22]"
